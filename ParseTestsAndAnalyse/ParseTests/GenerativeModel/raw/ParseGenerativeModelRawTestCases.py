...
for i in dirlist:
    abs_file_path_novel = path.abspath(path.join(abs_file_path_folder, i, "model_output_raw.txt"))
    ...
    rel_path = "parsedTestCases/parsed_requests_generative_model_raw_produced_" + i + ".csv"
